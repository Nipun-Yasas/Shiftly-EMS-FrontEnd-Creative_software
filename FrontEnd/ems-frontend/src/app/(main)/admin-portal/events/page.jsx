...
import NewEventsTab from './_components/NewEventsTab';
import AllEventsTab from './_components/AllEventsTab';
  ...
  return (
    <Paper elevation={2} sx={{ height: '100%', width: '100%'}}>
      ...
      <TabPanel value={tabValue} index={0}>
        <NewEventsTab {...tabProps} events={getFilteredEvents("pending")} />
      </TabPanel>

      <TabPanel value={tabValue} index={1}>
        <AllEventsTab {...tabProps} events={getFilteredEvents()} />
      </TabPanel>
